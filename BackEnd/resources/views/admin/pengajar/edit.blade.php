        ...
        <form action="{{ route('admin.manajemen-pengajar.update', $teacher->usersID) }}" method="POST" class="teacher-form" id="editForm">
            ...
            <div class="input-group">
                ...
                <div class="input-wrap">
                    <input type="text" name="name" id="name" value="{{ old('name', $teacher->name) }}" placeholder="Contoh: Kennedi Pane" required>
                </div>
            ...
            <div class="input-group">
                ...
                <div class="input-wrap">
                    <input type="email" name="email" id="email" value="{{ old('email', $teacher->email) }}" placeholder="admin@gmail.com" required>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <div class="input-wrap">
                    <input type="text" name="phone" id="phone" value="{{ old('phone', $teacher->phone) }}" placeholder="081234567890" required>
                </div>
            ...
            {{-- Profile Summary (Informasi Pengajar) --}}
