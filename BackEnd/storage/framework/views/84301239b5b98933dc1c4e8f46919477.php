...
<div class="tp-page">
    ...
    <section class="welcome-card">
        ...
        <div class="welcome-action">
            <a href="<?php echo e(route('admin.manajemen-pengajar.create')); ?>" class="tp-btn-primary-teal">
                Tambah Pengajar
            </a>
        </div>
    </section>
            ...
            <div class="tp-pagination">
                ...
                <?php if(method_exists($teachers, 'hasPages') && $teachers->hasPages()): ?>
                    <div class="tp-pages">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($teachers->previousPageUrl()); ?>" class="tp-page-btn">‹</a>
                        <?php endif; ?>
                        ...
                        <?php if($teachers->hasMorePages()): ?>
                            <a href="<?php echo e($teachers->nextPageUrl()); ?>" class="tp-page-btn">›</a>
                        <?php else: ?>
                            <span class="tp-page-btn disabled">›</span>
                        <?php endif; ?>
                    </div>
