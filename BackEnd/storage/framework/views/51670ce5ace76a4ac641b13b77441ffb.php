...
<div class="bn-page">
    ...
    <section class="welcome-card">
        ...
        <div class="welcome-action">
            <a href="<?php echo e(route('admin.banners.create')); ?>" class="bn-primary-btn-teal">
                Tambah Banner Baru
            </a>
        </div>
    </section>
            ...
            <div class="bn-banner-list">
                    ...
                    <article class="bn-banner-card">
                        ...
                        <div class="bn-banner-content">
                            ...
                            <div class="bn-actions">
                                <a href="<?php echo e(route('admin.banners.edit', $banner)); ?>" class="edit">Edit</a>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="bn-empty">
                        ...
                        <a href="<?php echo e(route('admin.banners.create')); ?>" class="bn-primary-btn-teal" style="margin-top: 15px; display: inline-flex;">Tambah Banner Pertama</a>
                    </div>
                <?php endif; ?>
            </div>
