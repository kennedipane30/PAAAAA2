<?php $__env->startSection('title', 'Dashboard Pengajar  Spekta Academy '); ?>
<?php $__env->startSection('subtitle', 'Spekta Academy'); ?>
        ...
        <div class="td-main-col">
            ...
            <header class="td-welcome-header">
                ...
                <div class="td-welcome-content">
                    <h1>Selamat Datang, <span class="td-name-highlight"><?php echo e($teacher->name); ?>!</span></h1>
            ...
            <section class="td-stats-grid">
                ...
                <div class="td-stat-card card-blue">
                    <div class="td-stat-content">
                        ...
                        <div class="td-stat-value"><?php echo e(number_format($totalKelas)); ?></div>
                        <span class="td-stat-sub">Kelas</span>
                    </div>
                </div>

                <!-- Card 2: Materi Diupload -->
                <a href="<?php echo e(route('pengajar.materi.index')); ?>" class="td-stat-card card-teal clickable-card">
                    <div class="td-stat-content">
                        <span class="td-stat-label">Materi Diupload</span>
                        <div class="td-stat-value"><?php echo e(number_format($totalMateri)); ?></div>
                        <span class="td-stat-sub">Berkas</span>
                    </div>
                </a>

                <!-- Card 3: Latihan Soal -->
                <a href="<?php echo e(route('pengajar.latihan.index')); ?>" class="td-stat-card card-orange clickable-card">
                    <div class="td-stat-content">
                        <span class="td-stat-label">Latihan Soal</span>
                        <div class="td-stat-value"><?php echo e(number_format($totalLatihan)); ?></div>
                        <span class="td-stat-sub">Tugas</span>
                    </div>
                </a>

                <!-- Card 4: Tryout Dibuat -->
                <a href="<?php echo e(route('pengajar.tryout.index')); ?>" class="td-stat-card card-purple clickable-card">
                    <div class="td-stat-content">
                        <span class="td-stat-label">Tryout Dibuat</span>
                        <div class="td-stat-value"><?php echo e(number_format($totalTryout)); ?></div>
                ...
                <div class="widget-body">
                    <?php if($jadwalUtama): ?>
                        <div class="agenda-item-active">
                            ...
                            <small><?php echo e(substr($jadwalUtama->start_time, 0, 5)); ?> WIB</small>
                        </div>
                    <?php else: ?>
