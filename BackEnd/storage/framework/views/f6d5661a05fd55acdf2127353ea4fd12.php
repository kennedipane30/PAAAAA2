        ...
        <form action="<?php echo e(route('admin.promo.store')); ?>" method="POST" class="pm-form">
            ...
            <div class="pm-input-group">
                ...
                <div class="pm-input-wrap">
                    <i class="fa-solid fa-ticket"></i>
                    <input type="text" name="code" value="<?php echo e(old('code')); ?>" placeholder="CONTOH: SPEKTA50" required style="text-transform: uppercase;">
                </div>
            </div>
            ...
            <div class="pm-input-group">
                ...
                <div class="pm-discount-wrap">
                    ...
                    <input type="number" name="discount_value" value="<?php echo e(old('discount_value')); ?>" placeholder="Nilai diskon" required>
            ...
            <div class="pm-input-group">
                ...
                <div class="pm-input-wrap">
                    ...
                    <input type="number" name="quota" value="<?php echo e(old('quota', 100)); ?>" placeholder="Contoh: 100" min="1" required>
                </div>
            </div>
