<?php $__env->startSection('title', 'Absesnsi Class Mingguan'); ?>
...
<div class="abs-page">
    ...
    <div class="abs-nav">
        <a href="<?php echo e(route('pengajar.absensi.index')); ?>" class="abs-back-btn">Kembali ke Daftar Kelas</a>
    </div>
            ...
            <?php for($i = 1; $i <= 20; $i++): ?>
                ...
                <a href="<?php echo e($isDone ? route('pengajar.absensi.recap', [$class->class_id, $subject, $i]) : route('pengajar.absensi.create', [$class->class_id, $subject, $i])); ?>"
                   class="abs-week-cell <?php echo e($isDone ? 'done' : 'open'); ?>">
                    ...
                    <span><?php echo e($isDone ? 'Lihat Rekap' : 'Mulai Absen'); ?></span>
                </a>
            <?php endfor; ?>
        </div>
    </section>
