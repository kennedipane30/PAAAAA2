                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="action-group-end">
                                        <?php if($totalSoal > 0): ?>
                                            <a href="<?php echo e(route('admin.tryout.export_draft', $c->class_id)); ?>" class="btn-icon-sm green-soft">CSV</a>
                                        <?php endif; ?>

                                        <a href="<?php echo e(route('admin.tryout.review', $c->class_id)); ?>" class="btn-review-teal">
                                            Review
                                        </a>
                                    </div>
                                </td>
